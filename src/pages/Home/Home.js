...
import data_news from '../../../res/数据新闻logo_pc.png' 
        ...
        return (
            <div id = "home-page" style = { bg }>
                ...
                <div id="title" style = {{
                    position:'absolute',
                    top: '237px',
                    left: this.state.isZh? '1000px' : '1010px',
                    width: '50px',
                ...
                <div className="en en-title-text" style = {{
                    position:'absolute',
                    top: '1191px',
                    left: this.state.isZh? '848px' : '754px',
                    width: '800px', 
                    }}>
                    <p>
                ...
                <div className="en en-label-text" style = {{
                    ...
                    <p>
                    Note: The routes showed on the map illustrate the whole life tracks of the poets, hence some of the points are repeated one than once.
                    </p>
                </div>
                }
                ...
                <div className="en en-label-text" style = {{
                    ...
                    <p>
                    The Migration of the Poets in Song Dynasty
                    </p>
                </div>
                }
                ...
                <div className="en en-label-text" style = {{
                    ...
                    <p>
                    The timeline of the Poets in Song Dynasty
                    </p>
                </div>
                }
                ...
                <div className="en en-label-text" style = {{
                    position:'absolute',
                    top: '6620px',
                    left: this.state.isZh? '480px' : '831px',
                    width: '1000px', 
                    fontWeight: 'bolder'
                    }}>
                    <p>
                        The Popular Images and Emotions of the Typical Poets 
                    </p>
                </div>
                }
                ...
                <div 
                    ...
                    style={{
                        position:'absolute',
                        top: this.state.isZh? '2250px' : '2550px',
                        left:'500px'
                    }}
                    >
                ...
                <div style = {{
                    position:'absolute',
                    top: this.state.isZh? '2650px': '3050px',
                    left: '500px',
                    }}>
                    <svg
                        width = '150'
                ...
                <div 
                    ...
                    style={{
                        position:'absolute',
                        top: this.state.isZh ? '2887px' : '3207px',
                        left: '260px',
                        zIndex: 2
                    }}
                    >
                ...
                <div 
                    style={{
                        position:'absolute',
                        top: this.state.isZh? '3100px' : '3407px',
                        left: '240px',
                        width: '20px',
                        height: '100px',
                        fontSize: '16px',
                ...
                <div style = {{
                    position:'absolute',
                    top:  this.state.isZh? '3300px': '3600px',
                    left: '500px',
                    zIndex: 1
                    }}>
                    <svg
                    ...
                    >
                        ...
                        >
                        {this.state.isZh? "仕途阶段" : "Official Career"  }
                        </text>
                        <text
                            x = "100"
                            y = "15"
                        ...
                        >
                        {this.state.isZh? "平民阶段" : "Common People"  }
                        </text>
                ...
                <div style = {{
                    position:'absolute',
                    top: this.state.isZh? '4010px' : '4170px',
                    left: '583px',
                    width: '1000px', 
                    }}>
                    <img src={ title1 } style={this.state.isZh?{}:{width:'800px', maxHeight:'75px'}}/>
                </div>
                ...
                <div className='en en-sub-title' style = {{
                    ...
                    Every Life has its feelings, and, Poem is life 
                </div>
                }
                <div 
                    id="cloud"
                    style={{
                        position:'absolute',
                        top: this.state.isZh? '4100px': '4250px',
                        left:'400px',
                    }}
                    >
                    <CiCloud isZh={this.state.isZh}/>   
                </div>
                ...
                <div style = {{
                    position:'absolute',
                    top: this.state.isZh? '5350px' : '5500px',
                    left: '500px',
                    }}>
                    <svg
                        width = '260'
                    ...
                    />
                    <text
                        x = {this.state.isZh? "100" : '85'}
                        y = {this.state.isZh? "185" : '205'}
                        fill = 'black'
                        fontSize = '15'
                        fontFamily = 'W5'
                        fontWeight = 'bold'
                ...
                <div style = {{
                    position:'absolute',
                    top: this.state.isZh? '6564px' : '6707px',
                    left: this.state.isZh? '615px' : '640px',
                    width: '413px',
                    }}>
                    <img src={ title2 } style={this.state.isZh?{}:{width:'800px', maxHeight:'75px'}}/>
                </div>
                ...
                :
                <div className='en-sub-title' style = {{
                    position:'absolute',
                    top: '6694px',
                    left: '655px',
                    width: '1000px',
                    ...
                    Lubricant and tempting, grace everlasting
                </div>         
                ...
                :
                <div className="en-title-text" style = {{
                    position:'absolute',
                    top: '6770px',
                    left: '754px',
                    width: '800px', 
                ...
                <div style = {{
                    position:'absolute',
                    top: this.state.isZh? '4960px' : '5100px',
                    left:　'273px'
                    }}
                    id = "freq-line">
                ...
                <div className="zh-title-text" style = {{
                    ...
                    <p>
                    { this.state.isZh? "《全宋词》共收录词牌约1300个，词牌浣溪沙、水调歌头、菩萨蛮、鹧鸪天和满江红使用最为频繁。本文筛选其中常见的词牌，基于词谱和意象分布将其下的著名词篇绘制出来，以期为宋词提供新的赏析角度。" : ""}
                    </p>
                </div>

                <div style={{
                        position:'absolute',
                        top:this.state.isZh? '7200px' : '7200px',
                        left: '120px'
                    }}>
                ...
                >
                    <SonicView  isZh={this.state.isZh}/>
                </div>
                ...
                <div className="zh-bottom-text" style = {{
                    ...
                    <p>
                    <b>Production: </b>State Key Laboratory of Computer-Aided<br/> Design and Computer Graphics<br/>XINHUANET
                    </p>
                    <p>
                    <b>Copyright:  </b>State Key Laboratory of Computer-Aided<br/> Design and Computer Graphics<br/>Xinhuanet.com co. LTD
                    </p>
                    <p>
                    Copyright&copy;2000&nbsp;-&nbsp;2018 XINHUANET.com<br/>All Rights Reserved
                    </p>
                ...
                <div className="zh-bottom-text" style = {{
                    ...
                    <p>
                    1.The measured images and emotions were chosen <br/> by scholars.
                    </p>
                    <p>
                    2.The 20 typical poets were determined by their <br/> poetries included in the Whole Poetry of Song.
                    </p>
                    <p>
                    3.The map of the Song Dynasty was sketched <br/> based on the Historical Atlas of China.
                    </p>
                </div>
                }
